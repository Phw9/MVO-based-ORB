...
// bool mvo::Feature_KLT::CornerFAST(const cv::Mat& src)
// {
...
bool mvo::Feature_KLT::GoodFeaturesToTrack(const cv::Mat& src)
{
...
bool mvo::Feature_KLT::OpticalFlowPyrLK(const cv::Mat& src1, const cv::Mat& src2, mvo::Feature_KLT& next)
{
